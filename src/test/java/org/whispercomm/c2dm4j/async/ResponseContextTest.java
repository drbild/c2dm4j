...
/**
 * Unit tests for {@link ResponseContext}. The bulk of the testing is performed
 * by the parent class {@link AbstractContextTest}.
 * 
 * @author David R. Bild
 * 
 */
public class ResponseContextTest extends
		AbstractContextTest<Response, ResultDecision> {
	...
	@Override
	protected AbstractContext<Response, ResultDecision> getContext() {
		response = mock(Response.class);
		futureResponse = new FutureResponse();
		return new ResponseContext(futureResponse, response);
	}

	@Override
	protected Response getWrapped() {
		return response;
	}
